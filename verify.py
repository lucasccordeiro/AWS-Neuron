...
MANIFEST: list[Target] = [
    ...
    Target("mx_on_device_quantize",      "mx_on_device_quantize_matmul.py",      (),                "SUCCESSFUL", _SAFETY, "SUCCESSFUL"),
    Target("mx_on_device_quantize_buggy","mx_on_device_quantize_matmul_buggy.py",(),                "FAILED"),
    Target("mx_on_device_quantize_fp4",  "mx_on_device_quantize_matmul_fp4.py",  (),                "FAILED"),
    Target("mx_copy_strided",            "mx_copy_strided.py",                   (),                "SUCCESSFUL", _SAFETY, "SUCCESSFUL"),
    Target("mx_copy_strided_dma",        "mx_copy_strided_dma.py",               (),                "SUCCESSFUL", _SAFETY, "SUCCESSFUL"),
    Target("mx_copy_strided_buggy",      "mx_copy_strided_buggy.py",             (),                "FAILED"),
    Target("mx_quantize_small",          "mx_quantize_small.py",                 (),                "SUCCESSFUL", _SAFETY, "SUCCESSFUL"),
