...
# Larger harness: NUM_BLOCK_K/M/N = 2 to exercise block-interaction across
# the outer loops. Satisfies the kernel's divisibility asserts by construction.
TIBK: int = 2
TIBM: int = 2
TIBN: int = 2
K_dim: int = 2 * TIBK * PMAX                  # 512  (NUM_BLOCK_K = 2)
M_dim: int = 2 * TIBM * GEMM_STATIONARY_FMAX  # 512  (NUM_BLOCK_M = 2)
N_dim: int = 2 * TIBN * GEMM_MOVING_FMAX      # 2048 (NUM_BLOCK_N = 2)
