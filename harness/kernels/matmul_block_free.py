...
#
# nki_matmul_block_free_dimension_ — adds blocking on the M and N free
# dimensions. Upstream uses nested Python lists
# `lhsT_tiles[bm][k]` / `rhs_tiles[bn][k]`. We model each as a single
