...
#
# nki_tensor_add — ported verbatim from the upstream tutorial. After the
# PR chain through esbmc/esbmc#4555 (closing #4554), natural 2-axis
# subscript syntax `a[r0:r1, c0:c1]` works directly on Tile parameters
# of imported type via the Tile.__getitem__ stub.
