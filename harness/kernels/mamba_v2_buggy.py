...
#
# Positive control: off-by-one on the hoisted u_i load. The upstream
...
def mamba_v2(delta: Tile3D, u: Tile3D, A: Tile, B: Tile3D, C: Tile3D) -> Tile3D:
    ...
    for i_batch in nl_affine_range(batch_size):
        for i_channel_tile in nl_affine_range(n_channel_tile):
            ...
            # Hoisted: delta_i and u_i loaded once before the i_state loop.
            ...
            # BUG: row-end of u slice is channel_psize + 1 (off-by-one).
            u_slice: Tile = u[i_batch,
                              channel_start:channel_start + channel_psize + 1,
                              0:seq_len]
            ...
            for i_state in nl_affine_range(state_size):
                ...
                B_slice: Tile = B[i_batch, i_state:i_state + 1, 0:seq_len]
                ...
                C_slice: Tile = C[i_batch, i_state:i_state + 1, 0:seq_len]
