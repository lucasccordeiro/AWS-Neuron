...
#
# mamba_v3 — adds inner seq-tiling on top of v2's hoisted loads. A
# scan_init accumulator (channel_psize, 1) is carried across seq tiles
# via nisa.tensor_copy. Upstream hardcodes seq_len_fsize=512; the port
# accepts it as a parameter so the harness can pick a BMC-tractable
# value.
