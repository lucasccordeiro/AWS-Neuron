...
# qk_and_max + update_max. Same toy shape as the shape-skeleton harness
# (b=1, d=128, seqlen_q=seqlen_k=2048). Drives one execution of each
# of the upstream load_q / qk_and_max / update_max nested helpers per
# `grp_i in [0, num_grps)` per section.
#
# Expected ESBMC verdict: VERIFICATION SUCCESSFUL.

from stubs import *
from kernels.pipelined_attention import flash_fwd_update_max_only
...
o: Tile3D = flash_fwd_update_max_only(q, k, v)
