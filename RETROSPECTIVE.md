...
| [#4537](https://github.com/esbmc/esbmc/issues/4537) | OPEN | slice values don't thread into user-defined `__getitem__` parameters (3 distinct error modes) | keeps the `a[i:j, k:l]` → `slice2d(a, i, j, k, l)` rewrite in place |
