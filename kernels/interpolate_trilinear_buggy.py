...
#   - all loop-body conditional-bound variables are initialised to work
#     around the ESBMC bare-annotation crash (esbmc/esbmc#4510)
...
def interpolate_trilinear_2x_fwd(src_arr: Tile4D, chunk_size: int) -> Tile4D:
    ...
    while d < d_tiles_count:
        ...
        while p < p_tiles_count:
            ...
            # BUG: i_d_y axis widened to d_tile_size_src.
            # Allows i_d_dst_c to reach d_tile_size_dst (== out_tile.d1, OOB).
            i_d_y:   IndexTensor = mgrid_axis(0, d_tile_size_src)
