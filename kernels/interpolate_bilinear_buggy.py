...
#   - bare-annotation declarations inside loops are replaced by initialized
#     declarations to work around an ESBMC Python-frontend crash (separate issue)
...
def interpolate_bilinear_2x_fwd(src_arr: Tile3D, chunk_size: int) -> Tile3D:
    ...
    while h < h_tiles_count:
        ...
        while p < p_tiles_count:
            ...
            # BUG: i_h_y axis widened from h_tile_size_src - 1 to h_tile_size_src.
            # Allows i_h_dst to reach h_tile_size_dst (== out_tile.d1, OOB).
            i_h_y:  IndexTensor = mgrid_axis(0, h_tile_size_src)
